...
def data_trimmer(df: pd.DataFrame, datetime: str, trim: str):
    ...
    if trim == 'flight':
        ...
        start_time = pd.to_datetime('26/06/2025 17:14:55', format='%d/%m/%Y %H:%M:%S')
        end_time = pd.to_datetime('26/06/2025 17:22:00', format='%d/%m/%Y %H:%M:%S')
        ...
        # Define the time range
        start_time = pd.to_datetime('26/06/2025 17:14:55', format='%d/%m/%Y %H:%M:%S')
        end_time = pd.to_datetime('26/06/2025 17:15:19', format='%d/%m/%Y %H:%M:%S')
